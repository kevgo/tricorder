...
#[must_use]
pub fn staged_files(dir: Option<&Path>) -> Option<StagedFiles> {
...
mod tests {
    ...
    mod staged_files {
        ...
        fn includes_fully_staged_file_with_spaces() {
            ...
            let have = super::super::staged_files(Some(dir.path())).unwrap();
            pretty::assert_eq!(
                have,
                StagedFiles {
                    partial: vec![],
